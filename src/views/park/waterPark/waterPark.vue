<template>
    <div class="container-hook">
        ...
        <div class="container">
            ...
            <div class="ecovillage">
                <router-link :to="{path: 'ecoVillage'}">
                    <img :src="ecovillage" alt="">
                </router-link>
            </div>
            <!-- 超人气设施 -->
            <div class="facility" v-if="facilityList.length>0">
                <div class="title">
                    <h2>超人气设施</h2>
                    <router-link :to="{path: '/park/facility?area=四季恒温水乐园'}">更多 ></router-link>
                </div>
                <div class="facility-hook">
                    <ul class="facility_list">
                        <li v-for="(item, index) in facilityList">
                            <router-link :to="{path: '/facilityDetail?id='+item.id+'&area=四季恒温水乐园&from=recommend'}" :key="index">
            ...
            <div class="strategy">
                <div class="title">
                    <h2>人气攻略</h2>
                    <router-link :to="{path: '/strategy/strategy?area=四季恒温水乐园'}">更多 ></router-link>
                </div>
                    ...
                    <div class="service_right">
                        ...
                        <div class="service_more">
                            <div class="service_more_item service_map">
                                <router-link :to="{path: '/park/waterPark/map'}">
                                    <h2>景区地图</h2>
            ...
            <!-- 景区服务 -->
            <!-- 关注微信 -->
            <footer-common :aboutUsPath="'/aboutUs'" :hotline="'0512-69581925'"></footer-common>
            <!-- 关注微信 -->
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            entryList: [
                ...
                {
                    path: "/park/facility?area=四季恒温水乐园",
                    text: "景区设施"
                },
                {
            ...
            ecovillage: require("./images/ecovillage.png")
        }
    },
    components: {
        innerHeader,
    ...
    mounted() {
        var _ts = this;
        this._getRecommendStrategy("四季恒温水乐园");
        this.$nextTick(() => {
            setTimeout(() => {
                new Swiper('.banner', {
