    ...
    <div class="container-hook">
        ...
        <div class="container">
            ...
            <div class="facility" v-if="facilityList.length>0">
                <div class="title">
                    <h2>超人气设施</h2>
                    <router-link :to="{path: '/park/facility?area=森林水世界'}">更多 ></router-link>
                </div>
                <div class="facility-hook">
                    <ul class="facility_list">
                        <li v-for="(item, index) in facilityList">
                            <router-link :to="{path: '/facilityDetail?id='+item.id+'&area=森林水世界&from=recommend'}" :key="index">
            ...
            <div class="strategy">
                <div class="title">
                    <h2>人气攻略</h2>
                    <router-link :to="{path: '/strategy/strategy?area=森林水世界'}">更多 ></router-link>
                </div>
...
export default {
    ...
    mounted() {
        var _ts = this;
        this._getRecommendStrategy("森林水世界");
        this.$nextTick(() => {
            setTimeout(() => {
                new Swiper('.banner', {
