    ...
    <div class="container-hook">
        ...
        <div class="container">
            ...
            <div class="facility" v-if="facilityList.length>0">
                <div class="title">
                    <h2>超人气设施</h2>
                    <router-link :to="{path: '/park/facility?area=森林世界'}">更多 ></router-link>
                </div>
                <div class="facility-hook">
                    <ul class="facility_list">
                        <li v-for="(item, index) in facilityList">
                            <router-link :to="{path: '/facilityDetail?id='+item.id+'&area=森林世界&from=recommend'}" :key="index">
            ...
            <div class="strategy">
                <div class="title">
                    <h2>人气攻略</h2>
                    <router-link :to="{path: '/strategy/strategy?area=森林世界'}">更多 ></router-link>
                </div>
                ...
                <div class="service_list">
                    ...
                    <div class="service_right">
                        <div class="service_time">
                            <p style="margin-top: 0.3rem;">敬请期待</p>
                            <!-- <h2>周一至周日 </h2>
                            <h3>10：30~21：00</h3>
                            <p>（2018年10月27日起）</p> -->
                            <em></em>
...
export default {
    ...
    mounted() {
        var _ts = this;
        this._getRecommendStrategy("森林世界");
        this.$nextTick(() => {
            setTimeout(() => {
                new Swiper('.banner', {
